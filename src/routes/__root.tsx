...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Richi Rich — Filmmaker, Cinematographer & Creative" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "Richi Rich HQ" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Archivo:wght@400;600;800;900&family=Inter+Tight:wght@300;400;500&family=JetBrains+Mono:wght@400;500&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
